...
export default defineComponent({
  ...
  setup() {
    ...
    function setPosition() {
      if (!scrollbarDom.value?.wrapRef) {
        return
      }
      
      const activeDom = scrollbarDom.value.wrapRef.querySelector('.active')
      const activeFather = scrollbarDom.value.wrapRef.querySelector('.el-scrollbar__view')
      
      if (!activeDom || !activeFather) {
        return
      }
      
      const domBox = {
        scrollbar: scrollbarDom.value.wrapRef as HTMLDivElement,
        activeDom: activeDom as HTMLDivElement,
        activeFather: activeFather as HTMLDivElement
      }
